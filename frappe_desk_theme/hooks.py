...
app_include_css = "/assets/frappe_desk_theme/css/frappe_desk_theme.bundle.css?v=8"
# app_include_js = "/assets/frappe_desk_theme/js/frappe_desk_theme.bundle.js"

app_include_js = [
	"/assets/frappe_desk_theme/js/frappe_desk_theme.bundle.js?v=6",
	"/assets/frappe_desk_theme/js/sidebar/sidebar_override.bundle.js?v=6",
